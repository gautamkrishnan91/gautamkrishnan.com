                                      ...
                                      hstatus_ind = 9;
                                       ...
                                       markertypes.setLatLng(L.latLng(latvalues[pointsAdded],lngvalues[pointsAdded])).addTo(typeLayer);
                                        markertypes.on('mouseover', function (e) {
                                          document.getElementById("details").innerHTML="Selected Hurricane is "+hname+"  Windspeed : "+windspeed[pointsAdded]+"<br>Pressure(in millibars) :" + pressure[pointsAdded] + "  Status :"+ hstatus[pointsAdded]});
