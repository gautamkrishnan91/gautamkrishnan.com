...
$(document).ready(function(){
	...
	$("#graphs").css("height",$("#map").height());
	$( "#filterAccordion" ).accordion();
	$("#orderby, #filterby").css("visibility","hidden");
	avail_height = $(document).height()/4;
	$(".graph-section").height(avail_height+100);
		...
		if (xmlhttp.readyState==4) 
		{
			...
			else
			{
				...
				if($('#individual').is(':checked')) 
					...
					{
				document.getElementById("details").innerHTML=" Hover on a hurricane to see more information about it here.";
				$(".play").show();
				$(".pause").hide();
				get_Id(hid);
...
$("#section1 .switch1").click(function(){
	...
	$("#section1 .switcher").css("border-radius","4px 0 0 4px");
	$("#section1 .switch2").css("color","#333");
	$("#section1 .switch1").css("color","#FFF");
	$("#section1 .graphs-container").css("margin-left","-410px");
});	
$("#section1 .switch2").click(function(){
	$("#section1 .switcher").css("left","100px");
	$("#section1 .switcher").css("border-radius","0 4px 4px 0");
...
$("#section2 .switch1").click(function(){
	...
	$("#section2 .switcher").css("border-radius","4px 0 0 4px");
	$("#section2 .switch2").css("color","#333");
	$("#section2 .switch1").css("color","#FFF");
	$("#section2 .graphs-container").css("margin-left","-410px");
});	
$("#section2 .switch2").click(function(){
	$("#section2 .switcher").css("left","150px");
	$("#section2 .switcher").css("border-radius","0 4px 4px 0");
...
$("#section3 .switch1").click(function(){
	...
	$("#section3 .switcher").css("border-radius","4px 0 0 4px");
	$("#section3 .switch2").css("color","#333");
	$("#section3 .switch1").css("color","#FFF");
	$("#section3 .graphs-container").css("margin-left","-410px");
});	
$("#section3 .switch2").click(function(){
	$("#section3 .switcher").css("left","150px");
	$("#section3 .switcher").css("border-radius","0 4px 4px 0");
...
$("#section4 .switch1").click(function(){
	...
	$("#section4 .switcher").css("border-radius","4px 0 0 4px");
	$("#section4 .switch2").css("color","#333");
	$("#section4 .switch1").css("color","#FFF");
	$("#section4 .graphs-container").css("margin-left","-410px");
});	
$("#section4 .switch2").click(function(){
	$("#section4 .switcher").css("left","150px");
	$("#section4 .switcher").css("border-radius","0 4px 4px 0");
...
$(".material-design-hamburger__icon").click(function(){
	$("#graphs").toggleClass("show");
});

// Show/Hide Legend
$(".legend-icon-outer").click(function(){
	$(".universal-legend").toggleClass("hidden expanded");
});